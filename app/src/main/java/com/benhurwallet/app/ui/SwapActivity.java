...
import com.benhurwallet.app.entity.lifi.Chain;
import com.benhurwallet.app.entity.lifi.Connection;
import com.benhurwallet.app.entity.lifi.Quote;
import com.benhurwallet.app.entity.lifi.Token;
import com.benhurwallet.app.ui.widget.entity.ActionSheetCallback;
import com.benhurwallet.app.ui.widget.entity.ProgressInfo;
import com.benhurwallet.app.util.BalanceUtils;
import com.benhurwallet.app.util.SwapUtils;
import com.benhurwallet.app.viewmodel.SwapViewModel;
import com.benhurwallet.app.viewmodel.Tokens;
...
import com.benhurwallet.app.widget.SelectTokenDialog;
import com.benhurwallet.app.widget.StandardHeader;
import com.benhurwallet.app.widget.SwapSettingsDialog;
import com.benhurwallet.app.widget.TokenInfoView;
import com.benhurwallet.app.widget.TokenSelector;
...
public class SwapActivity extends BaseActivity implements StandardFunctionInterface, ActionSheetCallback
{
    ...
    private com.benhurwallet.app.entity.tokens.Token token;
    ...
    private ActionSheetDialog createConfirmationAction(Quote quote)
    {
        ...
        try
        {
            com.benhurwallet.app.entity.tokens.Token activeToken = viewModel.getTokensService().getTokenOrBase(sourceToken.chainId, sourceToken.address);
