...
import com.benhurwallet.app.util.StyledStringBuilder;
...
public class Web3Transaction implements Parcelable {
     ...
     * @param minGas
     */
    public Web3Transaction(com.benhurwallet.app.entity.Transaction tx, ActionSheetMode mode, BigInteger minGas)
    {
