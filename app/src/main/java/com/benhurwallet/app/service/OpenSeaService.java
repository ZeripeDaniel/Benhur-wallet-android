...
public class OpenSeaService
{
    ...
    public void resetOffsetRead(List<Long> networkFilter)
    {
        ...
        {
            if (com.benhurwallet.app.repository.EthereumNetworkBase.hasOpenseaAPI(networkId))
            {
    ...
    {
        if (!com.benhurwallet.app.repository.EthereumNetworkBase.hasOpenseaAPI(token.tokenInfo.chainId))
        {
            return Single.fromCallable(() -> "");
        }
        else
